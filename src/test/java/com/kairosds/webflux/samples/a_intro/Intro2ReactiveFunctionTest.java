package com.kairosds.webflux.samples.a_intro;
...
class Intro2ReactiveFunctionTest {
  ...
  void whenReceiveIntegersThenReturnIt() {
    ...
    // WHEN
    final Flux<Integer> integerFlux = this.intro2_reactiveFunction.getIntegers().delayElements(Duration.ofSeconds(1));
